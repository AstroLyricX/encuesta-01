                            ...
                            child: Container(
                              ...
                              child: Wrap(
                                ...
                                children: [
                                  const Center(
                                      heightFactor: 2,
                                      child: Text('2.8. has de  pastos naturales?')),
                                  SizedBox(
                                      width: 120,
                                      child: TextFormField(
                                        decoration: const InputDecoration(
                            ...
                            child: Container(
                              ...
                              child: Wrap(
                                ...
                                children: [
                                  const Center(
                                      heightFactor: 2,
                                      child: Text('2.10 ¿Por qué razon decidio sembrar los cultivos que  tiene en sus tierras?')),
                                  SizedBox(
                                      child: TextFormField(
                                        decoration: const InputDecoration(
                                            labelText: '¿Por qué?'),
                            ...
                            child: Container(
                              ...
                              child: Wrap(
                                ...
                                children: [
                                  const Center(
                                      heightFactor: 2,
                                      child: Text('3.2. ¿Cuál es el tipo de riego que utiliza?')),
                                  SizedBox(
                                    width: 160,
                                    child: SwitchListTile.adaptive(
                                      title: const Text('No, Si'),
